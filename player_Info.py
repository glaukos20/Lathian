		...
		if player_Pronouns == "1":
			...
			while True:
				...
				if player_Pronouns == "1":
					...
					player_Pronoun_Subjective = input("Please input your prefered subjective pronoun (Ex. He, She, They)\n").lower()
					player_Pronoun_Objective = input("Please input your prefered objective pronoun (Ex. Him, Her, Them)\n").lower()
					player_Pronoun_Possessive = input("Please input your prefered possessive pronoun (Ex. His, Hers, Theirs)\n").lower()
